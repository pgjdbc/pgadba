...
public enum ColumnTypes {
  ...
  LSEG(601, TextParser::lineSegmentOut, BinaryParser::lseg_send, null, null),
  PATH(602, TextParser::pathOut, BinaryParser::path_send, null, null),
  BOX(603, TextParser::boxOut, BinaryParser::box_send, null, null),
  POLYGON(604, TextParser::polyOut, BinaryParser::poly_send, null, null),
  LINE(628, TextParser::lineOut, BinaryParser::line_send, null, null),
  _LINE(629, TextParser::lineOutArray, BinaryParser::array_send, null, null),
  ...
  _LSEG(1018, TextParser::lineSegmentOutArray, BinaryParser::array_send, null, null),
  _PATH(1019, TextParser::pathOutArray, BinaryParser::array_send, null, null),
  _BOX(1020, TextParser::boxOutArray, BinaryParser::array_send, null, null),
  ...
  _POLYGON(1027, TextParser::polyOutArray, BinaryParser::array_send, null, null),
  ...
  INT4RANGE(3904, TextParser::integerRangeOut, BinaryParser::range_send, null, null),
  _INT4RANGE(3905, TextParser::integerRangeOutArray, BinaryParser::array_send, null, null),
  NUMRANGE(3906, TextParser::numericRangeOut, BinaryParser::range_send, null, null),
  _NUMRANGE(3907, TextParser::numericRangeOutArray, BinaryParser::array_send, null, null),
  TSRANGE(3908, TextParser::localDateTimeRangeOut, BinaryParser::range_send, null, null),
  _TSRANGE(3909, TextParser::localDateTimeRangeArrayOut, BinaryParser::array_send, null, null),
  TSTZRANGE(3910, TextParser::offsetDateTimeRangeOut, BinaryParser::range_send, null, null),
  _TSTZRANGE(3911, TextParser::offsetDateTimeRangeArrayOut, BinaryParser::array_send, null, null),
  DATERANGE(3912, TextParser::localDateRangeOut, BinaryParser::range_send, null, null),
  _DATERANGE(3913, TextParser::localDateRangeArrayOut, BinaryParser::array_send, null, null),
  INT8RANGE(3926, TextParser::longRangeOut, BinaryParser::range_send, null, null),
  _INT8RANGE(3927, TextParser::longRangeOutArray, BinaryParser::array_send, null, null),
