...
public class LocalDateTimeRange implements Comparable<LocalDateTimeRange> {
   ...
   */
  public LocalDateTimeRange(LocalDateTime lower, LocalDateTime upper, boolean lowerInclusive, boolean upperInclusive) {
    this.lower = lower;
    this.upper = upper;
   ...
   */
  public void setLower(LocalDateTime lower) {
    this.lower = lower;

    canonicalize();
  }

  public LocalDateTime getUpper() {
    return upper;
  }
   ...
   */
  public void setUpper(LocalDateTime upper) {
    this.upper = upper;
  ...
  public boolean equals(Object o) {
    ...
    LocalDateTimeRange numericRange = (LocalDateTimeRange) o;
