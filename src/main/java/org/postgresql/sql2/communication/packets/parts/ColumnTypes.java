...
public enum ColumnTypes {
  ...
  private final BiFunction<byte[], Class<?>, Object> binaryParser;
  private final Class c;
  private final PgAdbaType type;

  ColumnTypes(int oid, BiFunction<String, Class<?>, Object> textParser,
      BiFunction<byte[], Class<?>, Object> binaryParser, Class c, PgAdbaType type) {
    this.oid = oid;
  ...
  public BiFunction<byte[], Class<?>, Object> getBinaryParser() {
    return binaryParser;
  }
